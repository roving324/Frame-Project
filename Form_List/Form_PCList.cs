...
namespace Form_List
{
	public partial class Form_PCList : Assambl.Base_Form
	{
		...
		private void Form_PCList_Load(object sender, EventArgs e)
		{
			...
			_GridUtil.InitColumnUltraGrid(MENU, "MENU" , "메뉴"    , false, GridColDataType_emu.VarChar , 130, 130, Infragistics.Win.HAlign.Left, true, false);
